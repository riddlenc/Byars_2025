...
graph_301 <- ggetho(dt_t1_301, aes(x = t, y = nd, colour = treatment)) + 
  ...
  theme(strip.background = element_rect(fill = "white")) + 
  theme(strip.text = element_text(colour = "black")) +
  annotate('rect', xmin = -25200, xmax = 0, ymin = 0, ymax = 11, alpha = 0.5, fill = "darkgrey") +
  annotate('rect', xmin = 43200, xmax = 59500, ymin = 0, ymax = 11, alpha = 0.5, fill = "darkgrey") +
  annotate('rect', xmin = -3600, xmax = 3600, ymin = 0, ymax = 11, alpha = 0, color = "black", linewidth = 1) +  # 6-8 AM
  annotate('rect', xmin = 18000, xmax = 25200, ymin = 0, ymax = 11, alpha = 0, color = "black", linewidth = 1) +  # 12-2 PM
  annotate('rect', xmin = 39600, xmax = 46800, ymin = 0, ymax = 11, alpha = 0, color = "black", linewidth = 1) +  # 6-8 PM
  stat_pop_etho() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
...
#graph 304
When plotting just 304 data we did not need to shift the x-axis by 1hr like we did for the graph_t1 because we already marked 0=6AM on the metadata sheet and the x-axis wasn't being prepared across all genotypes. Thus, the x-axis automatically is properly shifted to account for the time change.
```{r}
graph_304 <- ggetho(dt_t1_304, aes(x = t, y = nd, colour = treatment)) + 
  ...
  theme(strip.background = element_rect(fill = "white")) + 
  theme(strip.text = element_text(colour = "black")) +
  annotate('rect', xmin = -25200, xmax = 0, ymin = 0, ymax = 3.3, alpha = 0.5, fill = "darkgrey") +
  annotate('rect', xmin = 43200, xmax = 59500, ymin = 0, ymax = 3.3, alpha = 0.5, fill = "darkgrey") +
  annotate('rect', xmin = -3600, xmax = 3600, ymin = 0, ymax = 3.3, alpha = 0, color = "black", linewidth = 1) +  # 6-8 AM
  annotate('rect', xmin = 18000, xmax = 25200, ymin = 0, ymax = 3.3, alpha = 0, color = "black", linewidth = 1) +  # 12-2 PM
  annotate('rect', xmin = 39600, xmax = 46800, ymin = 0, ymax = 3.3, alpha = 0, color = "black", linewidth = 1) +  # 6-8 PM
  stat_pop_etho() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        legend.position = "none")
...
#graph 786
When plotting just 786 data we did not need to shift the x-axis by 1hr like we did for the graph_t1 because we already marked 0=6AM on the metadata sheet and the x-axis wasn't being prepared across all genotypes. Thus, the x-axis automatically is properly shifted to account for the time change.
```{r}
