...
```{r}
shapiro.test(master_t0_304$daily_activity)
shapiro.test(master_t1_304$daily_activity)
shapiro.test(master_t2_304$daily_activity)
shapiro.test(master_t3_304$daily_activity)
```
