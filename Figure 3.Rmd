...
graph_301 <- ggetho(dt_t1_301, aes(x = t, y = nd, colour = treatment)) + 
  ...
  annotate('rect', xmin = -3600, xmax = 3600, ymin = 0, ymax = 12.5, alpha = 0, color = "red", linewidth = 1) +  # 6-8 AM
  annotate('rect', xmin = 18000, xmax = 25200, ymin = 0, ymax = 12.5, alpha = 0, color = "red", linewidth = 1) +  # 12-2 PM
  annotate('rect', xmin = 39600, xmax = 46800, ymin = 0, ymax = 12.5, alpha = 0, color = "red", linewidth = 1) +  # 6-8 PM
  stat_pop_etho() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        legend.position = "none")
...
graph_304 <- ggetho(dt_t1_304, aes(x = t, y = nd, colour = treatment)) + 
  ...
  annotate('rect', xmin = -3600, xmax = 3600, ymin = 0, ymax = 3.2, alpha = 0, color = "red", linewidth = 1) +  # 6-8 AM
  annotate('rect', xmin = 18000, xmax = 25200, ymin = 0, ymax = 3.2, alpha = 0, color = "red", linewidth = 1) +  # 12-2 PM
  annotate('rect', xmin = 39600, xmax = 46800, ymin = 0, ymax = 3.2, alpha = 0, color = "red", linewidth = 1) +  # 6-8 PM
  stat_pop_etho() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        legend.position = "none")
...
graph_786 <- ggetho(dt_t1_786, aes(x = t, y = nd, colour = treatment)) + 
  ...
  annotate('rect', xmin = -3600, xmax = 3600, ymin = 0, ymax = 5.6, alpha = 0, color = "red", linewidth = 1) +  # 6-8 AM
  annotate('rect', xmin = 18000, xmax = 25200, ymin = 0, ymax = 5.6, alpha = 0, color = "red", linewidth = 1) +  # 12-2 PM
  annotate('rect', xmin = 39600, xmax = 46800, ymin = 0, ymax = 5.6, alpha = 0, color = "red", linewidth = 1) +  # 6-8 PM
  stat_pop_etho() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        legend.position = "none")
...
graph_852 <- ggetho(dt_t1_852, aes(x = t, y = nd, colour = treatment)) + 
  ...
  annotate('rect', xmin = -3600, xmax = 3600, ymin = 0, ymax = 11.5, alpha = 0, color = "red", linewidth = 1) +  # 6-8 AM
  annotate('rect', xmin = 18000, xmax = 25200, ymin = 0, ymax = 11.5, alpha = 0, color = "red", linewidth = 1) +  # 12-2 PM
  annotate('rect', xmin = 39600, xmax = 46800, ymin = 0, ymax = 11.5, alpha = 0, color = "red", linewidth = 1) +  # 6-8 PM
  stat_pop_etho() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        legend.position = "none")
