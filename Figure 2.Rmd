...
t0
```{r}
master_t0_786$genotype <- as.factor(master_t0_786$genotype)
master_t0_786$sex <- as.factor(master_t0_786$sex)
master_t0_786$treatment <- as.factor(master_t0_786$treatment)
...
t1
```{r}
master_t1_786$genotype <- as.factor(master_t1_786$genotype)
master_t1_786$sex <- as.factor(master_t1_786$sex)
master_t1_786$treatment <- as.factor(master_t1_786$treatment)
...
t2
```{r}
master_t2_786$genotype <- as.factor(master_t2_786$genotype)
master_t2_786$sex <- as.factor(master_t2_786$sex)
master_t2_786$treatment <- as.factor(master_t2_786$treatment)
...
t3
```{r}
master_t3_786$genotype <- as.factor(master_t3_786$genotype)
master_t3_786$sex <- as.factor(master_t3_786$sex)
master_t3_786$treatment <- as.factor(master_t3_786$treatment)
...
t0
```{r}
master_t0_304$genotype <- as.factor(master_t0_304$genotype)
master_t0_304$sex <- as.factor(master_t0_304$sex)
master_t0_304$treatment <- as.factor(master_t0_304$treatment)
...
t1
```{r}
master_t1_304$genotype <- as.factor(master_t1_304$genotype)
master_t1_304$sex <- as.factor(master_t1_304$sex)
master_t1_304$treatment <- as.factor(master_t1_304$treatment)
...
t2
```{r}
master_t2_304$genotype <- as.factor(master_t2_304$genotype)
master_t2_304$sex <- as.factor(master_t2_304$sex)
master_t2_304$treatment <- as.factor(master_t2_304$treatment)
...
t3
```{r}
master_t3_304$genotype <- as.factor(master_t3_304$genotype)
master_t3_304$sex <- as.factor(master_t3_304$sex)
master_t3_304$treatment <- as.factor(master_t3_304$treatment)
...
#Run the Tukey HSD, change the data name as needed
```{r}
