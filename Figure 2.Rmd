...
#combine t0-t2 for 852
All 3 timepoints had significant effects in the females
```{r}
...
#masters for extra analysis
```{r}
master_301 <- rbind(master_t0_301, master_t1_301, master_t2_301, master_t3_301)
master301_female <- subset(master_301, sex == "F")
```
t0 only significant treatment timepoint for females
#remove all the outliers from master_t0_301
```{r}
master_t0_301_outliers <- master_t0_301 %>%
  group_by(treatment, sex, age) %>%
  mutate(
    Q1 = quantile(daily_activity, 0.25, na.rm = TRUE),
    Q3 = quantile(daily_activity, 0.75, na.rm = TRUE),
...
Used this in the manuscript text
```{r}
activity_summary <- master_t0_301_outliers %>% 
  group_by(genotype, sex, age, treatment) %>% 
  summarise(
    mean_act = mean(daily_activity, na.rm = TRUE),
    total_act = sum(daily_activity, na.rm = TRUE),
...
# Plot DGRP301
```{r}
boxplot_301 <- ggplot(data = master_t0_301_outliers, aes(x = sex, y = daily_activity)) +
  geom_boxplot(aes(fill = "white", color = treatment), outlier.shape = NA, size=0.75) +
  geom_jitter(aes(x = sex, y = daily_activity, color = treatment), 
              alpha = 0.6, 
              position = position_jitterdodge(jitter.width = 0.2, jitter.height = 0), 
  ...
  facet_grid(~age) +
  scale_fill_manual(values = "white") + 
  scale_color_manual(values = c("#EFC000FF", "#BEBEBE"),
...
#scaled version for supplementary fig 2
```{r}
boxplot_301_scaled <- ggplot(data = master_t0_301_outliers, aes(x = sex, y = daily_activity)) +
  geom_boxplot(aes(fill = "white", color = treatment), outlier.shape = NA, size=0.75) +
  geom_jitter(aes(x = sex, y = daily_activity, color = treatment), 
              alpha = 0.6, 
              position = position_jitterdodge(jitter.width = 0.2, jitter.height = 0), 
...
#Plot DGRP304
```{r}
boxplot_304 <- ggplot(data = master_304_outliers, aes(x = sex, y = daily_activity)) +
  geom_boxplot(aes(fill = "white", color = treatment), outlier.shape = NA, size=0.75) +
  geom_jitter(aes(x = sex, y = daily_activity, color = treatment), 
              alpha = 0.6, 
              position = position_jitterdodge(jitter.width = 0.2, jitter.height = 0), 
...
#scaled version for supplementary fig 2
```{r}
boxplot_304_scaled <- ggplot(data = master_304_outliers, aes(x = sex, y = daily_activity)) +
  geom_boxplot(aes(fill = "white", color = treatment), outlier.shape = NA, size=0.75) +
  geom_jitter(aes(x = sex, y = daily_activity, color = treatment), 
              alpha = 0.6, 
              position = position_jitterdodge(jitter.width = 0.2, jitter.height = 0), 
...
```{r}
pairwise_females_t0 <- pairwise.t.test(females852_t0_outliers$daily_activity, females852_t0_outliers$treatment)
print(pairwise_females_t0)

pairwise_males_t0 <- pairwise.t.test(males852_t0_outliers$daily_activity, males852_t0_outliers$treatment)
print(pairwise_males_t0)
pairwise_females_t1 <- pairwise.t.test(females852_t1_outliers$daily_activity, females852_t1_outliers$treatment, p.adjust.method = "bonferroni")
...
pairwise_males_t2 <- pairwise.t.test(males852_t2_outliers$daily_activity, males852_t2_outliers$treatment, p.adjust.method = "bonferroni")
print(pairwise_males_t2)
```
Females C-5d t0, C-5D t1, C-5D t2 all significant
No significance among males
...
```
Significant treatment effects t0, t1, t2 males
...
Performed on data with outliers removed
```{r}
pairwise_females_t0 <- pairwise.t.test(females786_t0_outliers$daily_activity, females786_t0_outliers$treatment)
print(pairwise_females_t0)

pairwise_males_t0 <- pairwise.t.test(males786_t0_outliers$daily_activity, males786_t0_outliers$treatment)
print(pairwise_males_t0)

pairwise_females_t1 <- pairwise.t.test(females786_t1_outliers$daily_activity, females786_t1_outliers$treatment, p.adjust.method = "bonferroni")
print(pairwise_females_t1)
...
pairwise_females_t2 <- pairwise.t.test(females786_t2_outliers$daily_activity, females786_t2_outliers$treatment, p.adjust.method = "bonferroni")
print(pairwise_females_t2)
...
pairwise_females_t3 <- pairwise.t.test(females786_t3_outliers$daily_activity, females786_t3_outliers$treatment, p.adjust.method = "bonferroni")
...
```
Females t0 and Males t3 significant treatment effect
...
Performed on data with outliers removed
```{r}
pairwise_females_t0 <- pairwise.t.test(females301_t0_outliers$daily_activity, females301_t0_outliers$treatment)
print(pairwise_females_t0)

pairwise_males_t0 <- pairwise.t.test(males301_t0_outliers$daily_activity, males301_t0_outliers$treatment)
print(pairwise_males_t0)

pairwise_females_t1 <- pairwise.t.test(females301_t1_outliers$daily_activity, females301_t1_outliers$treatment, p.adjust.method = "bonferroni")
print(pairwise_females_t1)

pairwise_males_t1 <- pairwise.t.test(males301_t1$daily_activity, males301_t1$treatment, p.adjust.method = "bonferroni")
print(pairwise_males_t1)

pairwise_females_t2 <- pairwise.t.test(females301_t2_outliers$daily_activity, females301_t2_outliers$treatment, p.adjust.method = "bonferroni")
print(pairwise_females_t2)

pairwise_males_t2 <- pairwise.t.test(males301_t2$daily_activity, males301_t2$treatment, p.adjust.method = "bonferroni")
print(pairwise_males_t2)
```
...
```
Males t0, females t2, males t3 and females t3 treatment significant
...
```
Males t0, t3 significant
Females t1, t2 t3 significant
...
Performed on data with outliers removed
```{r}
pairwise_females_t0 <- pairwise.t.test(females304_t0_outliers$daily_activity, females304_t0_outliers$treatment)
print(pairwise_females_t0)
...
pairwise_males_t1 <- pairwise.t.test(males304_t1_outliers$daily_activity, males304_t1_outliers$treatment, p.adjust.method = "bonferroni")
print(pairwise_males_t1)
...
pairwise_males_t2 <- pairwise.t.test(males304_t2_outliers$daily_activity, males304_t2_outliers$treatment, p.adjust.method = "bonferroni")
print(pairwise_males_t2)
...
print(pairwise_males_t3)
```
Males t0 C-5d, t3 5d-20d and c-20d
Females t1 5d-20d, t2 5d-20d and c-20d, t3 5d-20d and c-20d